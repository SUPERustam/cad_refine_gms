...
# path to meshes
MAXPYROOT   = Path('/workspace-SR008.nfs2/users/zhemchuzhnikov/iterative_generation/elistratovm/monkey_patching/work_with_augmented/train_1_py')
MAXSTLS_ROOT   = Path('/workspace-SR008.nfs2/users/zhemchuzhnikov/iterative_generation/elistratovm/monkey_patching/work_with_augmented/train_1_stls')

DP_ROOT = Path("/workspace-SR008.nfs2/users/zhemchuzhnikov/datasets/deepcad_fusion_train")
