...
RUN_NAME="rl_gms_train_sft_30682_resume_49600"
BASE_DIR="/scratch/498rustam/cad_refine_m/${RUN_NAME}/"
...
RESUME="/scratch/498rustam/cad_refine_m/rl_checkpoints_resume_32800/checkpoint-49600" # RL latest checkpoint
